...
fn main() {
    ...
    //
    utils::print_difference(coords.0, coords.1); // Uncomment and finish this line
    ...
    utils::print_array(coords_arr); // and pass it in here (this line doesn't need to change)
    ...
    let mess = ([3, 2], 3.17, [(false, -3), (true, -100)], 5, "candy");
